...
mde_100000 = r"C:\Workspace\LagoValencia\raster\modelo.tif"
ASCII = r"C:\Workspace\TESIS CHRISTIAN\estudio batimetrico\Sort\valenciasel100.xyz"
...
capa_puntos = arcpy.ddd.ASCII3DToFeatureClass(
    input=ASCII,
    in_file_type="XYZ",
    out_feature_class=r"C:\Workspace\LagoValencia\LagoValencia.gdb\puntos",
...
topo_fc = r"C:\Workspace\LagoValencia\LagoValencia.gdb\puntos POINT_Z PointElevation"
...
lineas1 = arcpy.sa.Contour(
    mde_100000, r"C:\Workspace\LagoValencia\LagoValencia.gdb\lineas1", 10
)

# Extraer líneas de contorno del MDE Completo
lineas2 = arcpy.sa.Contour(
    mde_completo, r"C:\Workspace\LagoValencia\LagoValencia.gdb\lineas2", 10
)

# Aplicar TopoToRaster con contornos y puntos
arcpy.ddd.TopoToRaster(
    in_topo_features="puntos Z PointElevation;lineas1 Contour Contour;lineas2 Contour Contour",
    out_surface_raster=r"C:\Workspace\LagoValencia\LagoValencia.gdb\mde_integrado",
